      ...
      <React.Fragment>
        <div>
          <div className="city-list">
            {cityList.length >= 1 ? (
              allWxData.map((eachCity) => (
                <RenderCard key={uuid()} weather={eachCity} />
              ))
            ) : (
              <h3 className="cities-message">
                <em>
                  Visit the{" "}
                  <a href="http://localhost:3000/profile">Profile page</a> to
                  add cities to your account.
                </em>
              </h3>
            )}
          </div>
          ...
          <div class="quote">
            <p>
              <em>
                “When anyone tells me I can't do anything, I'm just not
                listening anymore” <br></br>
                <br></br>
                <strong>- Florence Griffith Joyner, Olympian</strong>
              </em>
            </p>
          </div>
        </div>
