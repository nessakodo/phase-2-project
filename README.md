...
#### 1. See what they can wear based off of:
...
#### 3. Input their name to create an account

### Patch Requirement

#### 4. Add cities to a rendered card list on the home page and view their weather conditions
